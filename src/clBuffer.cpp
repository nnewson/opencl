...
clBuffer::clBuffer(cl_context& context, cl_command_queue& commandQueue, size_t size)
...
void clBuffer::write(const void* input, size_t size)
{
    cl_int errorCode;
...
void clBuffer::read(void* output, size_t size)
{
    cl_int errorCode;
